                ...
                <div class="task">
                    <div class="content">
                        ...
                        <div class="priority">
                            ...
                            if ($priority == 'High') {
                                echo "<span style='background-color: red; padding: 0.2rem'>Sangat Penting!!</span>";;
                            } elseif ($priority == 'Medium') {
                                echo "<span style='background-color: yellow; padding: 0.2rem;'>Penting!</span>";;
                            } else {
                                echo "<span style='background-color: green; padding: 0.2rem;' >Tidak Penting</span>";
                            }
                            ?>
                        </div>
                        <div class="status">
